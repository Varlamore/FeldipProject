...
public class MusicPatch extends Node implements RSMusicPatch {
	...
	MusicPatch(byte[] var1) {
		...
		int var3;
		for (var3 = 0; var2.payload[var3 + var2.pos] != 0; ++var3) { // L: 29
																		// 30
		}
		...
		var2.pos += var3;
		int var6;
		for (var6 = 0; var2.payload[var6 + var2.pos] != 0; ++var6) {
		}
		...
		var2.pos += var6; // L: 44
		int var9;
		for (var9 = 0; var2.payload[var9 + var2.pos] != 0; ++var9) { // L: 45
																		// 46
		}
		...
		int var17;
		for (var17 = 0; var2.payload[var17 + var2.pos] != 0; ++var17) { // L:
																			// 83
																			// 84
		}
		...
		for (var24 = 0; var24 < 128; ++var24) { // L: 115
			if (this.field3254[var24] != 0) { // L: 116
				if (var20 == 0) { // L: 117
					...
					var23 = var2.payload[var5++] - 1; // L: 120
				}
		...
		for (int var25 = 0; var25 < 128; ++var25) { // L: 128
			if (this.field3254[var25] != 0) { // L: 129
				if (var20 == 0) { // L: 130
					...
					var24 = var2.payload[var8++] + 16 << 2; // L: 133
				}
		...
		for (var27 = 0; var27 < var12; ++var27) { // L: 164
			...
			if (var41.field3184 != null) { // L: 166
				for (var29 = 1; var29 < var41.field3184.length; var29 += 2) { // L:
																				// 167
					var41.field3184[var29] = var2.readByte();
				}
			}
			if (var41.field3181 != null) { // L: 169
				for (var29 = 3; var29 < var41.field3181.length - 2; var29 += 2) { // L:
																					// 170
		...
		for (var27 = 0; var27 < var12; ++var27) { // L: 179
			...
			if (var41.field3181 != null) { // L: 181
				var19 = 0; // L: 182
				for (var29 = 2; var29 < var41.field3181.length; var29 += 2) { // L:
																				// 183
		...
		for (var27 = 0; var27 < var12; ++var27) { // L: 189
			...
			if (var41.field3184 != null) { // L: 191
				var19 = 0; // L: 192
				for (var29 = 2; var29 < var41.field3184.length; var29 += 2) { // L:
																				// 193
		...
		if (var44 != null) { // L: 199
			...
			for (var29 = 2; var29 < var44.length; var29 += 2) { // L: 209 210
																// 227
				...
				for (var33 = var49; var33 < var30; ++var33) { // L: 214
					...
					this.field3253[var33] = (byte) (var34 * this.field3253[var33] + 32 >> 6); // L:
																								// 222
		...
		if (var16 != null) { // L: 232
			...
			int var48;
			for (var29 = 2; var29 < var16.length; var29 += 2) { // L: 247 248
																// 268
				...
				if (var8 != 0) { // L: 303
					if (var8 != var5) { // L: 304
						...
						if ((var8 & 1) == 0) { // L: 307
							...
							var6 = var1.getMusicSample(var8 >> 2, var3); // L:
																			// 308
						}
						if (var6 == null) { // L: 309
							var4 = false;
