...
public class VorbisResidue implements RSVorbisResidue {
	...
	void method768(float[] var1, int var2, boolean var3) {
		...
		if (!var3) { // L: 35
			var4 = VorbisSample.VorbisSample_codebooks[this.classbook].dimensions; // L:
																					// 36
			...
			for (int var8 = 0; var8 < 8; ++var8) { // L: 40
				...
				while (var9 < var6) { // L: 42
					...
					int var11;
					if (var8 == 0) { // L: 43
						var10 = VorbisSample.VorbisSample_codebooks[this.classbook].method956(); // L:
																									// 45
					...
					for (var10 = 0; var10 < var4; ++var10) { // L: 52
						...
						if (var12 >= 0) { // L: 56
							int var13 = var9 * this.partitionSize + this.begin; // L:
																				// 57
							VorbisCodebook var14 = VorbisSample.VorbisSample_codebooks[var12]; // L:
																								// 58
							int var15;
							if (this.residueType == 0) { // L: 59
								var15 = this.partitionSize / var14.dimensions; // L:
																				// 60
								for (int var19 = 0; var19 < var15; ++var19) { // L:
																				// 61
									float[] var20 = var14.method957(); // L: 62
									for (int var18 = 0; var18 < var14.dimensions; ++var18) { // L:
																								// 63
								...
								while (var15 < this.partitionSize) { // L: 68
									...
									for (int var17 = 0; var17 < var14.dimensions; ++var17) { // L:
																								// 70
										var1[var13 + var15] += var16[var17]; // L:
																				// 71
										++var15; // L: 72
									}
								}
