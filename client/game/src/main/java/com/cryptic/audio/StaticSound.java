...
public class StaticSound {
	...
	public static void LoginButton() {
		// TODO Auto-generated method stub
		ClientConstants.disableLoginScreenMusic = !ClientConstants.disableLoginScreenMusic; // L:
		// 312
		if (!ClientConstants.disableLoginScreenMusic) { // L: 313
...
// 318
	...
	public static final void method4532() {
				...
				if (StaticSound.queuedSoundEffectDelays[var0] < 0) { // L: 3658
					...
					if (StaticSound.soundLocations[var0] != 0) { // L: 3660
						...
						int var4 = StaticSound.soundLocations[var0] >> 16 & 255; // L:
																				// 3662
						int var5 = var4 * 128 + 64 - Client.local_player.x; // L:
																				// 3663
						if (var5 < 0) { // L: 3664
							var5 = -var5;
						}
						int var6 = StaticSound.soundLocations[var0] >> 8 & 255; // L:
																				// 3665
						int var7 = var6 * 128 + 64 - Client.local_player.y; // L:
																				// 3666
						if (var7 < 0) { // L: 3667
							var7 = -var7;
						}
						...
						var2 = (var3 - var8) * ClientConstants.areaSoundEffectVolume / var3; // L:
																								// 3674
					} else {
						var2 = ClientConstants.soundEffectVolume; // L:
																		// 3676
					}
					if (var2 > 0) { // L: 3677
		...
		if (StaticSound.playingJingle) { // L: 3686
			...
			if (!var12) { // L: 3695
				if (ClientConstants.musicVolume != 0 && StaticSound.currentTrackGroupId != -1) { // L:
																											// 3696
					StaticSound.method2410(StaticSound.archive6, StaticSound.currentTrackGroupId, 0, ClientConstants.musicVolume, false);
				}
	...
	public static final void updateMusicVolume(int var0) {
		...
		if (var0 != ClientConstants.musicVolume) { // L: 11841
			if (ClientConstants.musicVolume == 0 && currentTrackGroupId != -1) { // L:
																							// 11842
			...
			ClientConstants.musicVolume = var0; // L: 11851
		}
	} // L: 11853

	public static final void updateSoundEffectVolume(int var0) {
		var0 = Math.min(Math.max(var0, 0), 127);
		ClientConstants.soundEffectVolume = var0;
	}

	public static final void updateAreaVolume(int var0) {
		var0 = Math.min(Math.max(var0, 0), 127);
		ClientConstants.areaSoundEffectVolume = var0;
	}
	...
	public static void playAnimationSound(SequenceDefinition var0, int var1, int var2, int var3, Entity var4) {
		if (soundEffectCount < 50) {
			if (var0.getSoundEffects() != null && var1 < var0.getSoundEffects().length) {
				...
				if ((var5 <= 0 || ClientConstants.areaSoundEffectVolume != 0) && (var5 != 0 || ClientConstants.soundEffectVolume != 0)) {
					int var6 = var0.getSoundEffects()[var1];
					boolean var9 = var4 == Client.local_player;
					if (var6 != 0) {
						int var10 = var6 & 15;
						int var11;
						int var12;
	...
	public static void playJingle(int var0, int var1) {
		if (ClientConstants.musicVolume != 0 && var0 != -1) { // L:
			StaticSound.method2410(StaticSound.archive11, var0, 0, ClientConstants.musicVolume, false); // L:
			// 3779
	...
	public static void playSong(int var0) {
		if (var0 == -1 && !playingJingle) { // L: 3758
			method579(); // L: 3759
		} else if (var0 != -1 && var0 != currentTrackGroupId && ClientConstants.musicVolume != 0
				&& !playingJingle) { // L:
										// 3761
			Js5Archive var1 = StaticSound.archive6; // L: 3762
			int var2 = ClientConstants.musicVolume; // L: 3763
	...
	public static void queueSoundEffect(int var0, int var1, int var2) {
		if (ClientConstants.soundEffectVolume != 0 && var1 != 0 && soundEffectCount < 50) { // L:
	...
	public static void update() {
		...
		if (!ClientConstants.disableLoginScreenMusic) {
