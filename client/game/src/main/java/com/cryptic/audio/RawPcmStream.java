...
public class RawPcmStream extends PcmStream implements RSRawPcmStream {
			...
			if (this.numLoops < 0) { // L: 241
				if (this.field333) { // L: 242
					if (this.field332 < 0) { // L: 243
						var9 = this.method799(var1, var2, var5, var3, var4.samples[this.start]); // L:
																									// 244
						if (this.field331 >= var5) { // L: 245
							return;
						}
						this.field331 = var5 + var5 - 1 - this.field331; // L:
																			// 246
						this.field332 = -this.field332; // L: 247
					}
					while (true) {
						var9 = this.method888(var1, var9, var6, var3, var4.samples[this.end - 1]); // L:
																									// 250
						if (this.field331 < var6) { // L: 251
							return;
						}
						this.field331 = var6 + var6 - 1 - this.field331; // L:
																			// 252
						this.field332 = -this.field332; // L: 253
						var9 = this.method799(var1, var9, var5, var3, var4.samples[this.start]); // L:
																									// 254
					...
					while (true) {
						var9 = this.method799(var1, var9, var5, var3, var4.samples[this.end - 1]); // L:
																									// 262
						if (this.field331 >= var5) { // L: 263
							return;
						}
						this.field331 = var6 - 1 - (var6 - 1 - this.field331) % var8; // L:
																						// 264
					}
				} else {
					while (true) {
						var9 = this.method888(var1, var9, var6, var3, var4.samples[this.start]); // L:
																									// 269
						if (this.field331 < var6) { // L: 270
							return;
						}
						this.field331 = var5 + (this.field331 - var5) % var8; // L:
																				// 271
					}
				}
			} else {
					...
					if (this.field333) { // L: 276
						...
						if (this.field332 < 0) { // L: 297
							while (true) {
								...
								var10 = (var6 - 1 - this.field331) / var8; // L:
																			// 301
								if (var10 >= this.numLoops) { // L: 302
									this.field331 += var8 * this.numLoops; // L:
																			// 303
		...
		if (this.numLoops < 0) { // L: 388
			if (!this.field333) { // L: 389
				if (this.field332 < 0) { // L: 404
					...
					this.field331 = var4 - 1 - (var4 - 1 - this.field331) % var6; // L:
																					// 406
				} else {
					if (this.field331 < var4) { // L: 409
						return;
					}
					this.field331 = var3 + (this.field331 - var3) % var6; // L:
																			// 410
				}
			} else {
				...
				if (this.field333) { // L: 415
					label129 : {
						if (this.field332 < 0) { // L: 416
							...
							this.field331 = var3 + var3 - 1 - this.field331; // L:
																				// 418
						...
						do {
							...
							this.field331 = var4 + var4 - 1 - this.field331; // L:
																				// 424
	...
	public synchronized void method784() {
		this.field332 = (this.field332 ^ this.field332 >> 31) + (this.field332 >>> 31); // L:
																						// 113
	...
	public boolean method860() {
		return this.field331 < 0 || this.field331 >= ((RawSound) super.sound).samples.length << 8; // L:
																									// 192
	}
	...
	int method888(int[] var1, int var2, int var3, int var4, int var5) {
		while (true) {
			if (this.field342 > 0) { // L: 474
				...
				if (this.field332 == 256 && (this.field331 & 255) == 0) { // L:
																			// 478
					if (StaticSound.PcmPlayer_stereo) { // L: 479
						...
						var2 = method839(((RawSound) super.sound).samples, var1, this.field331, var2, this.field335, this.field344, 0, var6, var3, this); // L:
																																							// 480
					}
				} else if (StaticSound.PcmPlayer_stereo) { // L: 483
					...
					var2 = method813(0, 0, ((RawSound) super.sound).samples, var1, this.field331, var2, this.field335, this.field344, 0, var6, var3, this, this.field332, var5); // L:
																																													// 484
				}
			...
			if (this.field332 == 256 && (this.field331 & 255) == 0) { // L: 490
				if (StaticSound.PcmPlayer_stereo) { // L: 491
					return method824(0, ((RawSound) super.sound).samples, var1, this.field331, var2, this.field336, this.field337, 0, var4, var3, this);
				}
				return method801(((RawSound) super.sound).samples, var1, this.field331, var2, this.field335, 0, var4, var3, this); // L:
																																	// 492
			}
			if (StaticSound.PcmPlayer_stereo) { // L: 495
			...
			return method805(0, 0, ((RawSound) super.sound).samples, var1, this.field331, var2, this.field335, 0, var4, var3, this, this.field332, var5); // L:
																																							// 496
		}
	}
	int vmethod948() {
		...
		if (this.numLoops == 0) { // L: 33
			...
			var1 -= var1 * this.start / ((RawSound) super.sound).samples.length; // L:
																					// 34
		}
	...
	int method799(int[] var1, int var2, int var3, int var4, int var5) {
		while (true) {
			if (this.field342 > 0) { // L: 501
				...
				if (this.field332 == -256 && (this.field331 & 255) == 0) { // L:
																			// 505
					if (StaticSound.PcmPlayer_stereo) { // L: 506
						...
						var2 = method811(((RawSound) super.sound).samples, var1, this.field331, var2, this.field335, this.field344, 0, var6, var3, this); // L:
																																							// 507
					}
				} else if (StaticSound.PcmPlayer_stereo) { // L: 510
					...
					var2 = method820(0, 0, ((RawSound) super.sound).samples, var1, this.field331, var2, this.field335, this.field344, 0, var6, var3, this, this.field332, var5); // L:
																																													// 511
				}
			...
			if (this.field332 == -256 && (this.field331 & 255) == 0) { // L: 517
				if (StaticSound.PcmPlayer_stereo) { // L: 518
					return method905(0, ((RawSound) super.sound).samples, var1, this.field331, var2, this.field336, this.field337, 0, var4, var3, this);
				}
				return method921(((RawSound) super.sound).samples, var1, this.field331, var2, this.field335, 0, var4, var3, this); // L:
																																	// 519
			}
			if (StaticSound.PcmPlayer_stereo) { // L: 522
			...
			return method807(0, 0, ((RawSound) super.sound).samples, var1, this.field331, var2, this.field335, 0, var4, var3, this, this.field332, var5); // L:
																																							// 523
		}
	}
	boolean method798() {
		...
		if (var1 == this.field335 && var2 == this.field336 && var3 == this.field337) { // L:
																						// 540
			...
			if (this.field336 < var2) { // L: 550
				...
				if (this.field342 == 0 || this.field342 > var2 - this.field336) { // L:
																					// 552
					this.field342 = var2 - this.field336;
				}
			} else if (this.field336 > var2) { // L: 554
				this.field345 = -1; // L: 555
				if (this.field342 == 0 || this.field342 > this.field336 - var2) { // L:
																					// 556
			...
			if (this.field337 < var3) { // L: 559
				...
				if (this.field342 == 0 || this.field342 > var3 - this.field337) { // L:
																					// 561
					this.field342 = var3 - this.field337;
				}
			} else if (this.field337 > var3) { // L: 563
				this.field341 = -1; // L: 564
				if (this.field342 == 0 || this.field342 > this.field337 - var3) { // L:
																					// 565
	...
	private static int method841(int var0, int var1) {
		return var1 < 0 ? var0 : (int) ((double) var0 * Math.sqrt((double) (16384 - var1) * 1.220703125E-4D) + 0.5D); // L:
		// 23
	}
	private static int method771(int var0, int var1) {
		return var1 < 0 ? -var0 : (int) ((double) var0 * Math.sqrt((double) var1 * 1.220703125E-4D) + 0.5D); // L:
																												// 27
	}
	
	public static RawPcmStream createRawPcmStream(RawSound var0, int var1, int var2) {
		return var0.samples != null && var0.samples.length != 0 ? new RawPcmStream(var0, (int) ((long) var0.sampleRate * 256L * (long) var1 / (long) (StaticSound.sample_rate * 100)), var2 << 6) : null; // L:
																																																		// 63
																																																		// 64
	}
	
	public static RawPcmStream method775(RawSound var0, int var1, int var2, int var3) {
		return var0.samples != null && var0.samples.length != 0 ? new RawPcmStream(var0, var1, var2, var3) : null; // L:
		// 68
		// 69
	}
	
	private static int method801(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, RawPcmStream var8) {
		var2 >>= 8; // L: 583
		var7 >>= 8; // L: 584
		var4 <<= 2; // L: 585
		...
		int var10001;
		for (var5 -= 3; var3 < var5; var1[var10001] += var0[var2++] * var4) { // L:
																				// 587
																				// 588
			var10001 = var3++; // L: 589
	...
	private static int method824(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, RawPcmStream var10) {
		var3 >>= 8; // L: 603
		var9 >>= 8; // L: 604
		var5 <<= 2; // L: 605
		var6 <<= 2; // L: 606
		...
		int var10001;
		byte var11;
		for (var7 -= 6; var4 < var7; var2[var10001] += var11 * var6) { // L: 610
																		// 611
		...
		for (var7 += 6; var4 < var7; var2[var10001] += var11 * var6) { // L: 625
																		// 626
																		// 629
	...
	private static int method921(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, RawPcmStream var8) {
		var2 >>= 8; // L: 636
		var7 >>= 8; // L: 637
		var4 <<= 2; // L: 638
	...
	private static int method905(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, RawPcmStream var10) {
		var3 >>= 8; // L: 656
		var9 >>= 8; // L: 657
		var5 <<= 2; // L: 658
		var6 <<= 2; // L: 659
		...
		int var10001;
		byte var11;
		for (var7 -= 6; var4 < var7; var2[var10001] += var11 * var6) { // L: 663
																		// 664
		...
		for (var7 += 6; var4 < var7; var2[var10001] += var11 * var6) { // L: 678
																		// 679
																		// 682
	...
	private static int method805(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, RawPcmStream var10, int var11, int var12) {
		if (var11 == 0 || (var7 = var5 + (var11 + (var9 - var4) - 257) / var11) > var8) { // L:
																							// 689
			var7 = var8;
		}
		byte var13;
		...
		if (var11 == 0 || (var7 = var5 + (var11 + (var9 - var4) - 1) / var11) > var8) { // L:
																						// 696
			var7 = var8;
		}
		for (var1 = var12; var5 < var7; var4 += var11) { // L: 697 698 701
			...
			var10001 = var5++;
			var3[var10001] += ((var13 << 8) + (var1 - var13) * (var4 & 255)) * var6 >> 6; // L:
																							// 700
		}
	...
	private static int method806(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, RawPcmStream var11, int var12, int var13) {
		if (var12 == 0 || (var8 = var5 + (var10 - var4 + var12 - 257) / var12) > var9) { // L:
																							// 708
			var8 = var9;
		}
		var5 <<= 1; // L: 709
		...
		for (var8 <<= 1; var5 < var8; var4 += var12) { // L: 710 711 717
			...
			var0 = (var14 << 8) + (var4 & 255) * (var2[var1 + 1] - var14); // L:
																			// 714
			var10001 = var5++; // L: 715
		...
		if (var12 == 0 || (var8 = (var5 >> 1) + (var10 - var4 + var12 - 1) / var12) > var9) { // L:
																								// 719
			var8 = var9;
		}
		var8 <<= 1; // L: 720
	...
	private static int method807(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, RawPcmStream var10, int var11, int var12) {
		if (var11 == 0 || (var7 = var5 + (var11 + (var9 + 256 - var4)) / var11) > var8) { // L:
																							// 734
			var7 = var8;
		}
		int var10001;
		...
		if (var11 == 0 || (var7 = var5 + (var11 + (var9 - var4)) / var11) > var8) { // L:
																					// 741
			var7 = var8;
		}
		var0 = var12; // L: 742
		for (var1 = var11; var5 < var7; var4 += var1) { // L: 743 744 746
			var10001 = var5++;
			var3[var10001] += ((var0 << 8) + (var2[var4 >> 8] - var0) * (var4 & 255)) * var6 >> 6; // L:
																									// 745
		}
	...
	private static int method808(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, RawPcmStream var11, int var12, int var13) {
		if (var12 == 0 || (var8 = var5 + (var10 + 256 - var4 + var12) / var12) > var9) { // L:
																							// 753
			var8 = var9;
		}
		var5 <<= 1; // L: 754
		...
		if (var12 == 0 || (var8 = (var5 >> 1) + (var10 - var4 + var12) / var12) > var9) { // L:
																							// 764
			var8 = var9;
		}
		var8 <<= 1; // L: 765
		for (var1 = var13; var5 < var8; var4 += var12) { // L: 766 767 771
			var0 = (var1 << 8) + (var4 & 255) * (var2[var4 >> 8] - var1); // L:
																			// 768
			var10001 = var5++; // L: 769
			var3[var10001] += var0 * var6 >> 6;
			var10001 = var5++; // L: 770
	...
	private static int method839(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, RawPcmStream var9) {
		var2 >>= 8; // L: 778
		var8 >>= 8; // L: 779
		var4 <<= 2; // L: 780
		var5 <<= 2; // L: 781
	...
	private static int method810(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, RawPcmStream var12) {
		var3 >>= 8; // L: 807
		var11 >>= 8; // L: 808
		var5 <<= 2; // L: 809
		var6 <<= 2; // L: 810
	...
	private static int method811(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, RawPcmStream var9) {
		var2 >>= 8; // L: 855
		var8 >>= 8; // L: 856
		var4 <<= 2; // L: 857
		var5 <<= 2; // L: 858
	...
	private static int method831(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, RawPcmStream var12) {
		var3 >>= 8; // L: 884
		var11 >>= 8; // L: 885
		var5 <<= 2; // L: 886
		var6 <<= 2; // L: 887
	...
	private static int method813(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, RawPcmStream var11, int var12, int var13) {
		...
		while (var5 < var8) { // L: 935
			...
			var10001 = var5++;
			var3[var10001] += ((var14 << 8) + (var2[var1 + 1] - var14) * (var4 & 255)) * var6 >> 6; // L:
																									// 938
			var6 += var7; // L: 939
			var4 += var12; // L: 940
		}
		if (var12 == 0 || (var8 = var5 + (var10 - var4 + var12 - 1) / var12) > var9) { // L:
																						// 942
			var8 = var9;
		}
	...
	private static int method814(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, RawPcmStream var13, int var14, int var15) {
		var13.field335 -= var5 * var13.field344; // L: 958
		if (var14 == 0 || (var10 = var5 + (var12 - var4 + var14 - 257) / var14) > var11) { // L:
																							// 959
			var10 = var11;
		}
		var5 <<= 1; // L: 960
		...
		for (var10 <<= 1; var5 < var10; var4 += var14) { // L: 961 962 970
			...
			var0 = (var16 << 8) + (var4 & 255) * (var2[var1 + 1] - var16); // L:
																			// 965
			var10001 = var5++; // L: 966
			var3[var10001] += var0 * var6 >> 6;
			var6 += var8; // L: 967
		...
		if (var14 == 0 || (var10 = (var5 >> 1) + (var12 - var4 + var14 - 1) / var14) > var11) { // L:
																								// 972
			var10 = var11;
		}
		var10 <<= 1; // L: 973
	...
	private static int method820(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, RawPcmStream var11, int var12, int var13) {
		...
		while (var5 < var8) { // L: 996
			...
			var10001 = var5++;
			var3[var10001] += ((var14 << 8) + (var2[var1] - var14) * (var4 & 255)) * var6 >> 6; // L:
																								// 999
			var6 += var7; // L: 1000
			var4 += var12; // L: 1001
		}
		if (var12 == 0 || (var8 = var5 + (var10 - var4 + var12) / var12) > var9) { // L:
																					// 1003
			var8 = var9;
		}
		var0 = var13; // L: 1004
	...
	private static int method816(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, RawPcmStream var13, int var14, int var15) {
		var13.field335 -= var5 * var13.field344; // L: 1019
		if (var14 == 0 || (var10 = var5 + (var12 + 256 - var4 + var14) / var14) > var11) { // L:
																							// 1020
			var10 = var11;
		}
		var5 <<= 1; // L: 1021
		...
		for (var10 <<= 1; var5 < var10; var4 += var14) { // L: 1022 1023 1031
			...
			var0 = (var2[var1] - var16) * (var4 & 255) + (var16 << 8); // L:
																		// 1026
		...
		if (var14 == 0 || (var10 = (var5 >> 1) + (var12 - var4 + var14) / var14) > var11) { // L:
																							// 1033
			var10 = var11;
		}
		var10 <<= 1; // L: 1034
