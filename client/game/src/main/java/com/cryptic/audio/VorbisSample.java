...
public class VorbisSample extends Node implements RSVorbisSample {
	private static byte[] VorbisSample_bytes;
	private static int VorbisSample_byteOffset;
	private static int VorbisSample_bitOffset;
	private static int VorbisSample_blockSize0;
	private static int VorbisSample_blockSize1;
	
	static VorbisCodebook[] VorbisSample_codebooks;
	
	private static VorbisFloor[] VorbisSample_floors;
	
	private static VorbisResidue[] VorbisSample_residues;
	
	private static VorbisMapping[] VorbisSample_mappings;
	private static boolean[] VorbisSample_blockFlags;
	private static int[] VorbisSample_mapping;
	private static boolean field377 = false; // L: 28
	private static float[] field380;
	private static float[] field383;
	private static float[] field384;
	private static float[] field385;
	private static float[] field386;
	private static float[] field387;
	private static float[] field388;
	...
	float[] method991(int var1) {
		...
		readBit(); // L: 183
		int var2 = readBits(StaticSound.iLog(VorbisSample_mapping.length - 1)); // L:
																				// 184
		boolean var3 = VorbisSample_blockFlags[var2]; // L: 185
		int var4 = var3 ? VorbisSample_blockSize1 : VorbisSample_blockSize0; // L:
																				// 186
		...
		int var13;
		if (var3 && !var6) { // L: 210
			var11 = var4 - (var4 >> 2) - (VorbisSample_blockSize0 >> 2); // L:
																			// 211
			var12 = (VorbisSample_blockSize0 >> 2) + (var4 - (var4 >> 2)); // L:
																			// 212
		...
		VorbisMapping var14 = VorbisSample_mappings[VorbisSample_mapping[var2]]; // L:
																					// 220
		...
		for (var17 = 0; var17 < var14.submaps; ++var17) { // L: 228
			VorbisResidue var42 = VorbisSample_residues[var14.submapResidue[var17]]; // L:
																						// 229
		...
		if (var15) { // L: 240
			...
			for (var25 = 0; var25 < var18; ++var25) { // L: 254
				var26 = var20[var25 * 4] - var20[var4 - var25 * 4 - 1]; // L:
																		// 255
				var27 = var20[var25 * 4 + 2] - var20[var4 - var25 * 4 - 3]; // L:
																			// 256
				var28 = var40[var25 * 2]; // L: 257
				var29 = var40[var25 * 2 + 1]; // L: 258
				var20[var4 - var25 * 4 - 1] = var26 * var28 - var27 * var29; // L:
																				// 259
				var20[var4 - var25 * 4 - 3] = var26 * var29 + var27 * var28; // L:
																				// 260
			}
			float var30;
			float var31;
			for (var25 = 0; var25 < var19; ++var25) { // L: 262
				...
				var20[var25 * 4 + 3] = (var26 - var28) * var30 - (var27 - var29) * var31; // L:
																							// 271
				var20[var25 * 4 + 1] = (var27 - var29) * var30 + (var26 - var28) * var31; // L:
																							// 272
			}
			var25 = StaticSound.iLog(var4 - 1); // L: 274
			int var46;
			int var47;
			int var48;
			int var49;
			for (var46 = 0; var46 < var25 - 3; ++var46) { // L: 275
				...
				for (var49 = 0; var49 < 2 << var46; ++var49) { // L: 278
					...
					for (int var32 = 0; var32 < var4 >> var46 + 4; ++var32) { // L:
																				// 281
						...
						var20[var51 - 1 - var33] = (var34 - var36) * var38 - (var35 - var37) * var39; // L:
																										// 291
						var20[var51 - 3 - var33] = (var35 - var37) * var38 + (var34 - var36) * var39; // L:
																										// 292
					}
				}
			}
			...
			for (var46 = 0; var46 < var19; ++var46) { // L: 317
				...
				var20[var4 - var18 - 1 - var46 * 2] = var20[var46 * 4 + 2]; // L:
																			// 320
				var20[var4 - var18 - 2 - var46 * 2] = var20[var46 * 4 + 3]; // L:
																			// 321
			}
			for (var46 = 0; var46 < var19; ++var46) { // L: 323
				...
				float var53 = var28 * (var29 - var31) + var27 * (var30 + var52); // L:
																					// 330
				var20[var17 + var46 * 2] = (var29 + var31 + var53) * 0.5F; // L:
																			// 331
				var20[var4 - 2 - var46 * 2] = (var29 + var31 - var53) * 0.5F; // L:
																				// 332
				var53 = var28 * (var30 + var52) - var27 * (var29 - var31); // L:
																			// 333
				var20[var17 + var46 * 2 + 1] = (var30 - var52 + var53) * 0.5F; // L:
																				// 334
				var20[var4 - 1 - var46 * 2] = (-var30 + var52 + var53) * 0.5F; // L:
																				// 335
			}
			for (var46 = 0; var46 < var18; ++var46) { // L: 337
				var20[var46] = var20[var17 + var46 * 2] * var22[var46 * 2] + var20[var17 + var46 * 2 + 1] * var22[var46 * 2 + 1]; // L:
																																	// 338
				var20[var17 - 1 - var46] = var20[var17 + var46 * 2] * var22[var46 * 2 + 1] - var20[var17 + var46 * 2 + 1] * var22[var46 * 2]; // L:
																																				// 339
			}
			...
			for (var46 = var8; var46 < var9; ++var46) { // L: 345
				var27 = (float) Math.sin(((double) (var46 - var8) + 0.5D) / (double) var10 * 0.5D * 3.141592653589793D); // L:
				// 346
			...
			for (var46 = var11; var46 < var12; ++var46) { // L: 349
				var27 = (float) Math.sin(((double) (var46 - var11) + 0.5D) / (double) var13 * 0.5D * 3.141592653589793D + 1.5707963267948966D); // L:
																																				// 350
	...
	RawSound toRawSound(int[] var1) {
		if (var1 != null && var1[0] <= 0) { // L: 405
			...
			for (; this.field393 < this.field361.length; ++this.field393) { // L:
																			// 413
																			// 428
				...
				if (var2 != null) { // L: 416
					...
					for (int var5 = 0; var5 < var4; ++var5) { // L: 420
						int var6 = (int) (128.0F + var2[var5] * 128.0F); // L:
																			// 421
						if ((var6 & -256) != 0) { // L: 422
							var6 = ~var6 >> 31;
						}
			...
			return new RawSound(this.sampleRate, var7, this.start, this.end, this.field378); // L:
																								// 433
		}
	}
	static float float32Unpack(int var0) {
		...
		return (float) ((double) var1 * Math.pow(2.0D, (double) (var3 - 788))); // L:
																				// 51
	}
	private static void VorbisSample_setData(byte[] var0, int var1) {
		VorbisSample_bytes = var0; // L: 55
		VorbisSample_byteOffset = var1; // L: 56
		VorbisSample_bitOffset = 0; // L: 57
	} // L: 58
	static int readBit() {
		int var0 = VorbisSample_bytes[VorbisSample_byteOffset] >> VorbisSample_bitOffset & 1; // L:
																								// 61
	...
	static int readBits(int var0) {
		...
		int var2;
		int var3;
		for (var2 = 0; var0 >= 8 - VorbisSample_bitOffset; var0 -= var3) { // L:
																			// 70
																			// 71
																			// 78
			var3 = 8 - VorbisSample_bitOffset; // L: 72
			int var4 = (1 << var3) - 1; // L: 73
			var1 += (VorbisSample_bytes[VorbisSample_byteOffset] >> VorbisSample_bitOffset & var4) << var2; // L:
																											// 74
		...
		if (var0 > 0) { // L: 80
			var3 = (1 << var0) - 1; // L: 81
			var1 += (VorbisSample_bytes[VorbisSample_byteOffset] >> VorbisSample_bitOffset & var3) << var2; // L:
																											// 82
			VorbisSample_bitOffset += var0; // L: 83
		}
		return var1; // L: 85
	}
	private static void method984(byte[] var0) {
		...
		for (var1 = 0; var1 < 2; ++var1) { // L: 118
			var2 = var1 != 0 ? VorbisSample_blockSize1 : VorbisSample_blockSize0; // L:
																					// 119
			var3 = var2 >> 1; // L: 120
			var4 = var2 >> 2; // L: 121
			var5 = var2 >> 3; // L: 122
			...
			for (int var7 = 0; var7 < var4; ++var7) { // L: 124
				var12[var7 * 2] = (float) Math.cos((double) (var7 * 4) * 3.141592653589793D / (double) var2); // L:
																												// 125
				var12[var7 * 2 + 1] = -((float) Math.sin((double) (var7 * 4) * 3.141592653589793D / (double) var2)); // L:
				// 126
			}
			float[] var13 = new float[var3]; // L: 128
			for (int var8 = 0; var8 < var4; ++var8) { // L: 129
				var13[var8 * 2] = (float) Math.cos((double) (var8 * 2 + 1) * 3.141592653589793D / (double) (var2 * 2)); // L:
				// 130
				var13[var8 * 2 + 1] = (float) Math.sin((double) (var8 * 2 + 1) * 3.141592653589793D / (double) (var2 * 2)); // L:
																															// 131
			}
			float[] var14 = new float[var4]; // L: 133
			for (int var9 = 0; var9 < var5; ++var9) { // L: 134
				var14[var9 * 2] = (float) Math.cos((double) (var9 * 4 + 2) * 3.141592653589793D / (double) var2); // L:
				// 135
				var14[var9 * 2 + 1] = -((float) Math.sin((double) (var9 * 4 + 2) * 3.141592653589793D / (double) var2)); // L:
				// 136
			}
			int[] var15 = new int[var5]; // L: 138
			int var10 = StaticSound.iLog(var5 - 1); // L: 139
			for (int var11 = 0; var11 < var5; ++var11) { // L: 140
				var15[var11] = StaticSound.method302(var11, var10);
			}
			if (var1 != 0) { // L: 141
