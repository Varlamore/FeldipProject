...
import static com.cryptic.Client.*;
...
public class Camera {
    ...
    public static void updateCamera() {
        if (Client.instance.oculusOrbState == 0) {
            int playerX = local_player.x;
            int playerY = local_player.y;
            ...
            int highestHeight = Client.instance.get_tile_pos(Client.instance.plane, Client.instance.oculusOrbFocalPointY, Client.instance.oculusOrbFocalPointX);
            ...
            if (focalPointTileX > 3 && focalPointTileY > 3 && focalPointTileX < 100 && focalPointTileY < 100) {
                for (int x = focalPointTileX - 4; x <= focalPointTileX + 4; ++x) {
                    for (int y = focalPointTileY - 4; y <= focalPointTileY + 4; ++y) {
                        ...
                        if (effectivePlane < 3 && (Client.instance.tileFlags[1][x][y] & 2) == 2) {
                            ++effectivePlane;
                        }

                        int heightDifference = highestHeight - Client.instance.tileHeights[effectivePlane][x][y];
            ...
            oculusOrbAltitude = Client.instance.get_tile_pos(Client.instance.plane,local_player.y, local_player.x) - camFollowHeight;
        } else if (Client.instance.oculusOrbState == 1) {
            if (shouldUpdateFocalPoint && local_player != null) {
                int playerFirstPathX = local_player.pathX[0];
                int playerFirstPathY = local_player.pathY[0];
                if (playerFirstPathX >= 0 && playerFirstPathY >= 0 && playerFirstPathX < 104 && playerFirstPathY < 104) {
                    Client.instance.oculusOrbFocalPointX = local_player.x;
                    int heightDifference = Client.instance.get_tile_pos(Client.instance.plane,local_player.y, local_player.x) - camFollowHeight;
                    if (heightDifference < oculusOrbAltitude) {
                        oculusOrbAltitude = heightDifference;
                    }

                    Client.instance.oculusOrbFocalPointY = local_player.y;
        ...
        if (MouseHandler.currentButton == 4 && ClientConstants.mouseCam) {
    ...
    private static void updateCameraAndView() {
        ...
        if (!followCameraMode) {
            ...
            targetZ = Client.instance.get_tile_pos(Client.instance.plane, targetY, targetX) - cameraAltitudeOffset;
            ...
            if (fixedCamera) {
                ...
                Client.instance.cameraY = Client.instance.get_tile_pos(Client.instance.plane, Client.instance.cameraZ, Client.instance.cameraX) - camera.getCameraY();
            }
        ...
        if (!staticCameraMode) {
            ...
            targetZ = Client.instance.get_tile_pos(Client.instance.plane, targetY, targetX) - staticCameraAltitudeOffset;
    ...
    public static int determineRoofHeight() {
        if (Client.instance.settings[ConfigUtility.ROOF_REMOVAL_ID] == 1) {
            ...
            if (Client.instance.cameraPitch < 310) {
                ...
                if (Client.instance.oculusOrbState == 1) {
                    ...
                    focalPointX = local_player.x >> 7;
                    focalPointY = local_player.y >> 7;
                }
                ...
                if ((Client.instance.tileFlags[Client.instance.plane][cameraTileX][cameraTileZ] & 4) != 0) {
            ...
            if (local_player.x >= 0 && local_player.y >= 0 && local_player.x < 13312 && local_player.y < 13312) {
                if ((Client.instance.tileFlags[Client.instance.plane][local_player.x >> 7][local_player.y >> 7] & 4) != 0) {
                    calculatedPlane = Client.instance.plane;
                }
    ...
    public static int calculateCameraPlane() {
        if (Client.instance.settings[ConfigUtility.ROOF_REMOVAL_ID] == 1) {
            ...
            int cameraHeight = Client.instance.get_tile_pos(Client.instance.plane, Client.instance.cameraZ, Client.instance.cameraX);
            return cameraHeight - Client.instance.cameraY < 800 && (Client.instance.tileFlags[Client.instance.plane][Client.instance.cameraX >> 7][Client.instance.cameraZ >> 7] & 4) != 0 ? Client.instance.plane : 3;
        }
    }
