...
public class Mesh extends Renderable implements RSModelData {
    ...
    public List<net.runelite.api.model.Vertex> getVertices()
    {
        ...
        List<net.runelite.api.model.Vertex> vertices = new ArrayList<net.runelite.api.model.Vertex>(getVerticesCount());

        for (int i = 0; i < getVerticesCount(); ++i)
        {
            net.runelite.api.model.Vertex v = new net.runelite.api.model.Vertex(
                    verticesX[i],
                    verticesY[i],
                    verticesZ[i]
            );
