...
public class Settings {
    ...
    public void toggleVarbits() {
        Client.instance.toggleConfig(168, music_state);
        Client.instance.toggleConfig(169, sound_state);
        Client.instance.toggleConfig(780, area_state);
    ...
    private void writeLine(Float line1, BufferedWriter bw) {
        try {
    ...
    public void save() {
        ...
        try {
            ...
            writeLine("zoom_distance1", Client.field625, bw);
            ...
            writeLine("area_state", area_state, bw);
            ...
            writeLine("sounds", sounds_enabled, bw);
