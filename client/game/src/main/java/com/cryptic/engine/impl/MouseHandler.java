...
import com.cryptic.cache.graphics.widget.Slider;
...
public class MouseHandler implements MouseListener, MouseMotionListener, FocusListener {
    ...
    public static volatile int keypressedEventIndex;
        ...
        if (instance != null) {
            ...
            if (!mouseEvent.isConsumed()) {
                ...
                try {
                    ...
                    lastPressed = MonotonicClock.currentTimeMillis();
    ...
    public void mouseDragged(MouseEvent e) {
        ...
        if (!mouseEvent.isConsumed()) {
            isInEvent++;
            try {
                if (MouseWheelHandler.mouseWheelDown && Client.instance.settings[ConfigUtility.MOUSE_CAMERA_ID] == 1) {
