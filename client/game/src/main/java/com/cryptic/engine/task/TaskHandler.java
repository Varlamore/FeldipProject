...
public class TaskHandler implements Runnable, RSTaskHandler {
    ...
    public final Task newSocketTask(String name, int port) {
        return this.newTask(1, port, 0, name);
    }

    public final Task newThreadTask(Runnable runnable, int port) {
        return this.newTask(2, port, 0, runnable);
    }
