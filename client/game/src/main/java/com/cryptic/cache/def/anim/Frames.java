...
public class Frames extends DualNode {
    ...
    Frames(int var3, boolean var4) {
        ...
        for (int var8 = 0; var8 < var7.length; ++var8) {
            ...
            if (var10 == null) {
                byte[] var13;
                if (var4) {
                    var13 = Js5List.skeletons.getFile(0, var11);
                } else {
                    var13 = Js5List.skeletons.getFile(var11, 0);
                }
    ...
    public static Frames getFrames(int var0) {
        ...
        if (var1 != null) {
            ...
            if (var1 != null) {
                SequenceDefinition.cachedFrames.put(var1, (long) var0);
            }
    ...
    public static Frames getFrames(int var2, boolean var3) {
        ...
        for (int var6 = 0; var6 < var5.length; ++var6) {
            byte[] var7 = Js5List.animations.getFile(var2, var5[var6]);
            if (var7 == null) {
                var4 = false;
            } else {
                ...
                byte[] var9;
                if (var3) {
                    var9 = Js5List.skeletons.getFile(0, var8);
                } else {
                    var9 = Js5List.skeletons.getFile(var8, 0);
                }
