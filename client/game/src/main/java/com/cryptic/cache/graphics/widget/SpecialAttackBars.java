...
import com.cryptic.util.ItemIdentifiers;
...
public enum SpecialAttackBars {
    ...
    HEAVY_BALLISTA_OR(26712, "Concentrated Shot: Deal an attack with 25% increased accuracy and damage, but takes an additional 2.4 seconds to fire.", 65.0, 31352, 7649, 7661),
    ...
    TOXIC_STAFF_OF_THE_DEAD(12904, "Power of Death: Reduce all melee damage you receive by 50% for the next minute while the staff remains equipped. Stacks with Protect from Melee.", 100.0, 31345, 7474, 7486),
    STAFF_OF_LIGHT(22296, "Power of Death: Reduce all melee damage you receive by 50% for the next minute while the staff remains equipped. Stacks with Protect from Melee.", 100.0, 31345, 7474, 7486),
    ...
    CORRUPTED_VOIDWAKER(28531, "", 50.0, 31353, 7599, 7611),
    ...
    CORRUPTED_ARMADYL_GODSWORD(28537, "The Judgement: Deal an attack that inflicts 37.5% more damage with double accuracy.", 50.0, 31353, 7699, 7711),
    ...
    ABYSSAL_WHIP_OR(26482, "Energy Drain: Deal an attack with 25% increased accuracy that siphons 10% of your target's run energy.", 50.0, 31375, 12323, 12335),
    ...
    CORRUPTED_DRAGON_CLAWS(28534, "Slice and Dice: Hit 4 times in quick succession, with great accuracy.", 50.0, 31384, 7800, 7812),
    ...
    DRAGON_MACE_BH(27857, "Shatter: Increase damage by 50% and accuracy by 25% for one hit.", 25.0, 31406, 7624, 7636),
    ...
    ABYSSAL_DAGGER_BH(27867,"Abyssal Puncture: Deal an attack that hits twice with 25% increased accuracy, but inflicts 5% less damage per hit. The second hit is guaranteed if the first deals damage.",50.0, 31428, 7574, 7586),
    ...
    BLIGHTED_VESTAS_LONGSWORD(24617, "Feint: Deal an attack which treats your target's defence as if it was reduced by 75%. It will deal an minimum of 20% extra damage.", 25.0, 31351, 7599, 7611),
