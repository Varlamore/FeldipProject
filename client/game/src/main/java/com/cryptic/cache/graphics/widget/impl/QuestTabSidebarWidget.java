...
//        addHoverText(12661, "<col=FD5501>Open Our Website", "Go to "+ClientConstants.CLIENT_NAME+".com", font, 1, 0xff9933, false, true, 150, 11, 0xFFBD7D);
//        addHoverText(12662, "<col=FD5501>Discord: Click here", "Go to discord",font, 1, 0xff9933, false, true, 130, 11, 0xFFBD7D);
//        addHoverText(12663, "<col=FD5501>Open Webstore", "Go to the webstore", font, 1, 0xff9933, false, true, 150, 11, 0xFFBD7D);
//
//        addSprite(12664, 572);
...
//    }
    public static void unpackInfo(AdvancedFont[] font) {
        ...
        Widget scrolls = addTabInterface(12655);
        scrolls.height = 220;
        scrolls.scrollMax = 600;
        scrolls.width = 164;
        addSprite(12651, 175);//bg
...
//        addHoveredButton(12753, 1272, 18, 18, 12501);
        ...
        //  addText(12654, "Panel", font, 2, 0xff9933, false, true);
        //   addSprite(12656, 176);
        hoverButton10(12656, "Server", 176,176, "Server", font,2, 0xff9933, 0xff9933, true);//server text and header
        //  addText(12657, "Server:", font, 2, 0xff9933, false, true);
        // hoverButton10(12657, "Select", 2122,2122, "", font,2, 0xff9933, 0xffffff, true);
        addSprite(12657, 2085);//server bg

        addSprite(92651, 2086);//time
        addSprite(92652, 2087);//uptime
        addSprite(92653, 2088);//players online
        addSprite(92654, 2089);//next world boss


        addText(12658, "Time:", font, 0, 0xff9933, false, true);
        addText(12659, "Uptime:", font, 0, 0xff9933, false, true);
        addText(12700, "Players online:", font, 0, 0xff9933, false, true);
        addText(12660, "Next World Boss:", font, 0, 0xff9933, false, true);



        hoverButton10(12661, "Select", 2091,2090, "Official Website", font,1, 0xff9933, 0xffffff, true);
        hoverButton10(12662, "Select", 2091,2090, "Official Discord", font,1, 0xff9933, 0xffffff, true);
        hoverButton10(12663, "Select", 2091,2090, "Official Store", font,1, 0xff9933, 0xffffff, true);

//        addHoverText(12661, "Official Website", "www."+ClientConstants.CLIENT_NAME+"rsps.com", font, 1, 0xff9933, false, true, 150, 11, 0xFFBD7D);
//        addHoverText(12662, "Official Discord", "Discord",font, 1, 0xff9933, false, true, 130, 11, 0xFFBD7D);
//        addHoverText(12663, "Official Store", "Donate", font, 1, 0xff9933, false, true, 150, 11, 0xFFBD7D);

        //    addSprite(12664, 572);
        hoverButton10(12664, "Player", 176,176, "Player", font,2, 0xff9933, 0xff9933, true);//player text and header
        addSprite(12665, 2094);
        //  addText(12665, "Player:", font, 0, 0xff9933, false, true);
        addText(12666, "Game Mode:", font, 0, 0xff9933, false, true);
        addText(12667, "Play Time:", font, 0, 0xff9933, false, true);
        addText(12668, "Registered On:", font, 0, 0xff9933, false, true);
        addText(12669, "Member Rank:", font, 0, 0xff9933, false, true);
        addText(12670, "Total Donated:", font, 0, 0xff9933, false, true);
        addText(12671, "Vote Points:", font, 0, 0xff9933, false, true);
        addText(12672, "Boss Points:", font, 0, 0xff9933, false, true);
        addText(12673, "Referrals:", font, 0, 0xff9933, false, true);
        //Add string here and shift all ids by one hella work lol and reposition all the text too mkmk ill play with it later ty

        //    addSprite(12674, 570);
        addSprite(12674, 2092);//wildy bg
        //  addText(12675, "Wildy:", font, 0, 0xff9933, false, true);
        hoverButton10(12675, "Wilderness", 176,176, "Wilderness", font,2, 0xff9933, 0xff9933, true);//player text and header

        addText(12676, "Players in wild:", font, 0, 0xff9933, false, true);
        addText(12677, "Elo:", font, 0, 0xff9933, false, true);
        addText(12678, "Kills:", font, 0, 0xff9933, false, true);
        addText(12679, "Deaths:", font, 0, 0xff9933, false, true);
        addText(12680, "KDR:", font, 0, 0xff9933, false, true);
        addText(12681, "Targets killed:", font, 0, 0xff9933, false, true);
        addText(12682, "Killstreak:", font, 0, 0xff9933, false, true);
        addText(12683, "Wilderness streak:", font, 0, 0xff9933, false, true);
        addText(12684, "Highest killstreak:", font, 0, 0xff9933, false, true);
        addText(12685, "Target points:", font, 0, 0xff9933, false, true);
        addText(12686, "Wealth Risked:", font, 0, 0xff9933, false, true);
        addText(12687, "Wilderness Key:", font, 0, 0xff9933, false, true);

        addSprite(12688, 2093);
        hoverButton10(12689, "Slayer", 176,176, "Slayer", font,2, 0xff9933, 0xff9933, true);//slayer text and header

        //  addText(12689, "Slayer:", font, 0, 0xff9933, false, true);
        addText(12690, "Task:", font, 0, 0xff9933, false, true);
        addText(12691, "Task streak:", font, 0, 0xff9933, false, true);
        addText(12692, "Tasks completed:", font, 0, 0xff9933, false, true);
        addText(12693, "Slayer Keys Received:", font, 0, 0xff9933, false, true);
        addText(12694, "Slayer points:", font, 0, 0xff9933, false, true);

        addSprite(12695, 938);
        addText(12696, "Settings:", font, 2, 0xff9933, false, true);
        addCustomClickableText(12697, "Drag setting:", "Set", font, 1, 0xff9933, false, true, 135, 10);
        addCustomClickableText(12698, "Exp: (<col=ff0000>unlocked</col>)", "Select", font, 1, 0xff9933, false, true, 87, 10);
        ...
        int intChild = 0;
        int intChild2 = 0;
        scrolls.totalChildren(48);//Dont forget to change child ids too other wise big errs  kk, y determines height just play with that like the others are done they all go down by exact numbers I think
        scrolls.child(intChild2++, 12656, 0, 0);//child 0
        scrolls.child(intChild2++, 12657, 0, 29);
        scrolls.child(intChild2++, 12658, 20, 36);
        scrolls.child(intChild2++, 12659, 20, 51);
        scrolls.child(intChild2++, 12660, 20, 66);
        scrolls.child(intChild2++, 12700, 20, 81);

        scrolls.child(intChild2++, 92651, 5 ,39);//child 6
        scrolls.child(intChild2++, 92652, 5, 56);
        scrolls.child(intChild2++, 92653, 5, 71);
        scrolls.child(intChild2++, 92654, 5, 87);

        scrolls.child(intChild2++, 12661, 1, 100);
        scrolls.child(intChild2++, 12662, 1, 123);
        scrolls.child(intChild2++, 12663, 1, 146);
        scrolls.child(intChild2++, 12664, 0, 177);
        scrolls.child(intChild2++, 12665, 0, 205);
        scrolls.child(intChild2++, 12666, 1, 211);
        scrolls.child(intChild2++, 12667, 1, 222);
        scrolls.child(intChild2++, 12668, 1, 233);
        scrolls.child(intChild2++, 12669, 1, 244);
        scrolls.child(intChild2++, 12670, 1, 255);
        scrolls.child(intChild2++, 12671, 1, 266);
        scrolls.child(intChild2++, 12672, 1, 277);
        scrolls.child(intChild2++, 12673, 1, 288);
        scrolls.child(intChild2++, 12674, 0, 334);//wildy bg
        scrolls.child(intChild2++, 12675, 0, 305);///wildy header
        int yoffset=10;
        scrolls.child(intChild2++, 12676, 1, 340);
        scrolls.child(intChild2++, 12677, 1, 350);
        scrolls.child(intChild2++, 12678, 1, 360);
        scrolls.child(intChild2++, 12679, 1, 370);
        scrolls.child(intChild2++, 12680, 1, 380);
        scrolls.child(intChild2++, 12681, 1, 390);
        scrolls.child(intChild2++, 12682, 1, 400);
        scrolls.child(intChild2++, 12683, 1, 410);
        scrolls.child(intChild2++, 12684, 1, 420);
        scrolls.child(intChild2++, 12685, 1, 430);
        scrolls.child(intChild2++, 12686, 1, 440);
        scrolls.child(intChild2++, 12687, 1, 450);
        scrolls.child(intChild2++, 12688, 0, 509);//slayer bg
        scrolls.child(intChild2++, 12689, 0, 480);//slayer header
        scrolls.child(intChild2++, 12690, 1, 520);
        scrolls.child(intChild2++, 12691, 1, 530);
        scrolls.child(intChild2++, 12692, 1, 540);
        scrolls.child(intChild2++, 12693, 1, 550);
        scrolls.child(intChild2++, 12694, 1, 560);
        scrolls.child(intChild2++, 12695, 1000, 500);
        scrolls.child(intChild2++, 12696, 1, 5000);
        scrolls.child(intChild2++, 12697, 1, 5180);
        scrolls.child(intChild2++, 12698, 1, 5320);


        interface_.totalChildren(2);//12650
//        interface_.child(intChild++, 12652, 1540, 4);
//        interface_.child(intChild++, 12653, 1540, 4);
//        interface_.child(intChild++, 12754, 1720, 4);
//        interface_.child(intChild++, 12755, 1720, 4);
//        interface_.child(intChild++, 12654, 9000, 4);
        interface_.child(intChild++, 12651, 4, 14);
        interface_.child(intChild++, 12655, 6, 18);
        //   interface_.child(intChild++, 12700, 9, 244);
//        interface_.child(intChild++, 12750, 1306, 4);
//        interface_.child(intChild++, 12751, 1360, 4);
//        interface_.child(intChild++, 12752, 1180, 4);
//        interface_.child(intChild++, 12753, 1180, 4);
    }
