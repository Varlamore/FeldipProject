...
public final class Region {
    ...
    public void addPendingSpawnToScene(int z, int group, int x, int y, int id, int face, int type) {
        if (x >= 1 && y >= 1 && x <= 102 && y <= 102) {
            if (low_detail && z != Client.instance.plane) {
                return;
            }
            ...
            boolean var12 = false;
            if (group == 0) {
                var8 = Client.instance.scene.getBoundaryObjectTag(z, x, y);
            }

            if (1 == group) {
                var8 = Client.instance.scene.getWallDecorationTag(z, x, y);
            }

            if (2 == group) {
                var8 = Client.instance.scene.getGameObjectTag(z, x, y);
            }

            if (group == 3) {
                var8 = Client.instance.scene.getFloorDecorationTag(z, x, y);
            }

            int plane;
            if (0L != var8) {
                plane = Client.instance.scene.getObjectFlags(z, x, y, var8);
                int var40 = ViewportMouse.Entity_unpackID(var8);
                int var41 = plane & 31;
                int var42 = plane >> 6 & 3;
                ObjectDefinition def;
                if (0 == group) {
                    Client.instance.scene.remove_wall(x, z, y);
                    def = ObjectDefinition.get(var40);
                    if (def.interactType != 0) {
                        Client.instance.collisionMaps[z].removeWallObstruction(x, y, var41, var42, def.boolean1);
                    }
                }

                if (1 == group) {
                    Client.instance.scene.remove_wall_decor(y, z, x);
                }

                if (2 == group) {
                    Client.instance.scene.remove_object(z, x, y);
                    def = ObjectDefinition.get(var40);
                    ...
                    if (def.interactType != 0) {
                        Client.instance.collisionMaps[z].setFlagOffNonSquare(var42, def.sizeX, x, y, def.sizeY, def.boolean1);
                    }
                }

                if (3 == group) {
                    Client.instance.scene.remove_ground_decor(z, y, x);
                    def = ObjectDefinition.get(var40);
                    if (def.interactType == 1) {
                        Client.instance.collisionMaps[z].method3743(x, y);
                    }
                }
            }
            ...
            if (id >= 0) {
                ...
                SceneGraph var43 = Client.instance.scene;
                CollisionMap var15 = Client.instance.collisionMaps[z];
                ObjectDefinition var16 = ObjectDefinition.get(id);
                int var17;
                int var18;
                if (face != 1 && face != 3) {
                    var17 = var16.sizeX;
                ...
                Renderable var30;
                if (22 == type) {
                    if (-1 == var16.animationId && var16.transforms == null) {
                        var30 = var16.getModel(22, face, var23, var25, var24, var26);
                    } else {
                        var30 = new SceneObject(id, face, 22, plane, x, y, var16.animationId, var16.boolean3, (Renderable)null);
                    }
                    ...
                    if (type >= 12) {
                        if (var16.animationId == -1 && null == var16.transforms) {
                            var30 = var16.getModel(type, face, var23, var25, var24, var26);
                        } else {
                            var30 = new SceneObject(id, face, type, plane, x, y, var16.animationId, var16.boolean3, (Renderable)null);
                        }
                        ...
                        if (var16.animationId == -1 && var16.transforms == null) {
                            var30 = var16.getModel(0, face, var23, var25, var24, var26);
                        } else {
                            var30 = new SceneObject(id, face, 0, plane, x, y, var16.animationId, var16.boolean3, (Renderable)null);
                        }
                        ...
                        if (var16.animationId == -1 && var16.transforms == null) {
                            ...
                            var30 = new SceneObject(id, face, 1, plane, x, y, var16.animationId, var16.boolean3, (Renderable)null);
                        }
                        ...
                        if (2 == type) {
                            ...
                            Renderable var31;
                            Renderable var32;
                            if (-1 == var16.animationId && null == var16.transforms) {
                                var31 = var16.getModel(2, face + 4, var23, var25, var24, var26);
                                var32 = var16.getModel(2, var36, var23, var25, var24, var26);
                            } else {
                                var31 = new SceneObject(id, 4 + face, 2, plane, x, y, var16.animationId, var16.boolean3, (Renderable)null);
                                var32 = new SceneObject(id, var36, 2, plane, x, y, var16.animationId, var16.boolean3, (Renderable)null);
                            }
                            ...
                            if (-1 == var16.animationId && null == var16.transforms) {
                                ...
                                var30 = new SceneObject(id, face, 3, plane, x, y, var16.animationId, var16.boolean3, (Renderable)null);
                            }
                            ...
                            if (-1 == var16.animationId && var16.transforms == null) {
                                ...
                                var30 = new SceneObject(id, face, 4, plane, x, y, var16.animationId, var16.boolean3, (Renderable)null);
                            }
                            ...
                            if (type == 5) {
                                ...
                                if (var37 != 0L) {
                                    var36 = ObjectDefinition.get(ViewportMouse.Entity_unpackID(var37)).int2;
                                }

                                if (var16.animationId == -1 && var16.transforms == null) {
                                    var33 = var16.getModel(4, face, var23, var25, var24, var26);
                                } else {
                                    var33 = new SceneObject(id, face, 4, plane, x, y, var16.animationId, var16.boolean3, (Renderable)null);
                                }
                                ...
                                var37 = var43.getBoundaryObjectTag(z, x, y);
                                if (0L != var37) {
                                    var36 = ObjectDefinition.get(ViewportMouse.Entity_unpackID(var37)).int2 / 2;
                                }

                                if (-1 == var16.animationId && null == var16.transforms) {
                                    var33 = var16.getModel(4, face + 4, var23, var25, var24, var26);
                                } else {
                                    var33 = new SceneObject(id, face + 4, 4, plane, x, y, var16.animationId, var16.boolean3, (Renderable)null);
                                }
                                ...
                                if (var16.animationId == -1 && null == var16.transforms) {
                                    ...
                                    var30 = new SceneObject(id, 4 + var39, 4, plane, x, y, var16.animationId, var16.boolean3, (Renderable)null);
                                }
                                ...
                                if (var16.animationId == -1 && var16.transforms == null) {
                                    ...
                                    var33 = new SceneObject(id, face + 4, 4, plane, x, y, var16.animationId, var16.boolean3, (Renderable)null);
                                    var34 = new SceneObject(id, 4 + var35, 4, plane, x, y, var16.animationId, var16.boolean3, (Renderable)null);
                                }
                    ...
                    if (var16.animationId == -1 && var16.transforms == null) {
                        ...
                        var30 = new SceneObject(id, face, 10, plane, x, y, var16.animationId, var16.boolean3, (Renderable)null);
                    }
    ...
    public void addObjectsToScene(int z, int x, int y, int id, int face, int type, SceneGraph scene, CollisionMap collision) {
        if (!low_detail || 0 != (tile_flags[0][x][y] & 2) || (tile_flags[z][x][y] & 16) == 0) {
            ...
            ObjectDefinition var9 = ObjectDefinition.get(id);
            int var10;
            int var11;
            if (face != 1 && 3 != face) {
                var10 = var9.sizeX;
            ...
            if (22 == type) {
                if (!low_detail || 0 != var9.int1 || var9.interactType == 1 || var9.boolean2) {
                    if (var9.animationId == -1 && null == var9.transforms) {
                        renderable = var9.getEntity(22, face, heights, centerX, mean, centerY);
                    } else {
                        renderable = new SceneObject(id, face, 22, z, x, y, var9.animationId, var9.boolean3, (Renderable)null);
                    }
                ...
                if (type >= 12) {
                    if (var9.animationId == -1 && null == var9.transforms) {
                        ...
                        renderable = new SceneObject(id, face, type, z, x, y, var9.animationId, var9.boolean3, (Renderable)null);
                    }
                    ...
                    if (-1 == var9.animationId && null == var9.transforms) {
                        renderable = var9.getEntity(0, face, heights, centerX, mean, centerY);
                    } else {
                        renderable = new SceneObject(id, face, 0, z, x, y, var9.animationId, var9.boolean3, (Renderable)null);
                    }
                    ...
                    if (-1 == var9.animationId && null == var9.transforms) {
                        ...
                        renderable = new SceneObject(id, face, 1, z, x, y, var9.animationId, var9.boolean3, (Renderable)null);
                    }
                    ...
                    if (2 == type) {
                        ...
                        if (var9.animationId == -1 && var9.transforms == null) {
                            ...
                            var30 = new SceneObject(id, face + 4, 2, z, x, y, var9.animationId, var9.boolean3, (Renderable)null);
                            var31 = new SceneObject(id, var29, 2, z, x, y, var9.animationId, var9.boolean3, (Renderable)null);
                        }
                        ...
                        if (-1 == var9.animationId && var9.transforms == null) {
                            renderable = var9.getEntity(3, face, heights, centerX, mean, centerY);
                        } else {
                            renderable = new SceneObject(id, face, 3, z, x, y, var9.animationId, var9.boolean3, (Renderable)null);
                        }
                        ...
                        if (-1 == var9.animationId && var9.transforms == null) {
                            ...
                            renderable = new SceneObject(id, face, 4, z, x, y, var9.animationId, var9.boolean3, (Renderable)null);
                        }
                        ...
                        if (type == 5) {
                            ...
                            if (var32 != 0L) {
                                var29 = ObjectDefinition.get(ViewportMouse.Entity_unpackID(var32)).int2;
                            }

                            if (-1 == var9.animationId && null == var9.transforms) {
                                var34 = var9.getEntity(4, face, heights, centerX, mean, centerY);
                            } else {
                                var34 = new SceneObject(id, face, 4, z, x, y, var9.animationId, var9.boolean3, (Renderable)null);
                            }
                            ...
                            var32 = scene.getBoundaryObjectTag(z, x, y);
                            if (var32 != 0L) {
                                var29 = ObjectDefinition.get(ViewportMouse.Entity_unpackID(var32)).int2 / 2;
                            }

                            if (var9.animationId == -1 && null == var9.transforms) {
                                var34 = var9.getEntity(4, face + 4, heights, centerX, mean, centerY);
                            } else {
                                var34 = new SceneObject(id, 4 + face, 4, z, x, y, var9.animationId, var9.boolean3, (Renderable)null);
                            }
                            ...
                            if (var9.animationId == -1 && null == var9.transforms) {
                                ...
                                renderable = new SceneObject(id, 4 + var24, 4, z, x, y, var9.animationId, var9.boolean3, (Renderable)null);
                            }
                            ...
                            if (-1 == var9.animationId && null == var9.transforms) {
                                ...
                                var34 = new SceneObject(id, face + 4, 4, z, x, y, var9.animationId, var9.boolean3, (Renderable)null);
                                var27 = new SceneObject(id, var28 + 4, 4, z, x, y, var9.animationId, var9.boolean3, (Renderable)null);
                            }
                ...
                try {
                    if (-1 == var9.animationId && var9.transforms == null) {
                        ...
                        renderable = new SceneObject(id, face, 10, z, x, y, var9.animationId, var9.boolean3, (Renderable)null);
                    }
    ...
    public final void loadMapTerrain(Buffer arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        ...
        if (arg2 >= 0 && arg2 < 104 && arg3 >= 0 && arg3 < 104) {
            ...
            while (true) {
                ...
                if (1 == var8) {
                    int var9 = arg0.get_unsignedbyte();
                    if (var9 == 1) {
                        var9 = 0;
                    }
                ...
                if (var8 <= 49) {
                    overlays[arg1][arg2][arg3] = (short) arg0.get_short();
    ...
    public void loadTerrain(Buffer var0, int var1, int var2, int var3, int var4, int var5, int var6) {
        ...
        if (var7) {
            ...
            while (true) {
                ...
                if (var8 == 1) {
                    int var15 = var0.get_unsignedbyte();
                    if (var15 == 1) {
                        var15 = 0;
                    }
                ...
                if (var8 <= 49) {
                    overlays[var1][var2][var3] = (short) var0.get_short();
            ...
            while (true) {
                ...
                while (!var8) {
                    ...
                    if (var13 > 0 && var14 > 0 && var13 < 103 && var14 < 103) {
                        ObjectDefinition def = ObjectDefinition.get(var5);
    ...
    public void decode_map_locations(int chunkX, CollisionMap[] collision, int tileBits, SceneGraph sceneG, byte[] data) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                int height = position >> 12;
                int attributes = buffer.get_unsignedbyte();
                int type = attributes >> 2;
                int orientation = attributes & 3;
