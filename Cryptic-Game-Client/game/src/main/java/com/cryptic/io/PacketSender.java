...
public class PacketSender {
    ...
    public PacketSender(IsaacCipher cipher) {
        buffer = Buffer.create(BufferedConnection.SIZE, cipher);
    }
    ...
    public void sendClientReport(String msg) {
       ...
       // System.out.println("send header "+(msg.length() + 1)+" raw "+msg);
    }
    ...
    public void sendKeystroke(int keyId) {
       /* buffer.writeOpcode(3);
        buffer.writeInt(keyId);
        buffer.writeLong(System.currentTimeMillis() - lastKey);*/
    ...
    public void sendObjectExamine(int id) {
        buffer.writeOpcode(143);
