...
import com.cryptic.cache.def.anim.Animation;
...
import com.cryptic.entity.model.AABB;
...
public class Model extends Renderable implements RSModel {
    ...
    public void applySkeletalTransform(SkeletalFrameHandler var1, int var2) {
        ...
        if (var4 != null) {
            var3.getSkeletalBase().method5272(var1, var2);
    ...
    public void transform(int animationType, int[] skinArray, int x, int y, int z) {
        ...
        if (animationType == 0) {
            ...
            if (var7 > 0) {
                Model_transformTempX = x + Model_transformTempX / var7;
                Model_transformTempY = y + Model_transformTempY / var7;
                Model_transformTempZ = z + Model_transformTempZ / var7;
            } else {
    ...
    public final void drawFace(int var1) {
        ...
        if (callbacks == null || !callbacks.drawFace(this, var1))
        {
            if (field2169[var1]) {
    ...
    public void render_3D(int orientation, int pitchSine, int pitchCos, int yawSin, int yawCos, int offsetX, int offsetY, int offsetZ, long uid) {
        if (this.boundsType != 1) {
            this.calculateBoundsCylinder();
        }
