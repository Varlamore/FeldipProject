...
public class SoundCache implements RSSoundCache {
	...
	RawSound getSoundEffect0(int var1, int var2, int[] var3) {
		...
		if (var7 != null) { // L: 22
			...
			SoundEffect var8 = SoundEffect.readSoundEffect(this.soundEffectIndex, var1, var2); // L:
																								// 24
			if (var8 == null) { // L: 25
				return null;
			} else {
	...
	RawSound getMusicSample0(int var1, int var2, int[] var3) {
		...
		if (var7 != null) { // L: 37
			...
			VorbisSample var8 = (VorbisSample) this.musicSamples.get(var5); // L:
																			// 39
			if (var8 == null) { // L: 40
				var8 = VorbisSample.readMusicSample(this.musicSampleIndex, var1, var2); // L:
																						// 41
				if (var8 == null) { // L: 42
					return null;
				}
