...
public class MusicTrack extends Node implements RSMusicPatch {
	
	NodeHashTable table;
	byte[] midi;
	
	MusicTrack(Buffer var1) {
		var1.pos = var1.payload.length - 3; // L: 22
		...
		var13 = var1.pos; // L: 80
		var14 = var2 + var5 + var6 + var7 + var8 + var9 + var10 + var11 + var12; // L:
																					// 81
		for (var15 = 0; var15 < var14; ++var15) { // L: 82
			var1.readVarInt();
		}
		var4 += var1.pos - var13; // L: 83
		var15 = var1.pos; // L: 84
		int var16 = 0; // L: 85
		int var17 = 0; // L: 86
		int var18 = 0; // L: 87
		...
		for (var29 = 0; var29 < var6; ++var29) { // L: 98
			...
			if (var28 != 0 && var28 != 32) { // L: 100
				if (var28 == 1) { // L: 101
					...
					++var25;
				} else if (var28 != 64 && var28 != 65 && var28 != 120 && var28 != 121 && var28 != 123) { // L:
																											// 111
					++var27; // L: 112
				} else {
					++var26;
		...
		var29 = 0; // L: 114
		int var30 = var1.pos; // L: 115
		var1.pos += var26; // L: 116
		int var31 = var1.pos; // L: 117
		var1.pos += var11; // L: 118
		int var32 = var1.pos; // L: 119
		var1.pos += var10; // L: 120
		int var33 = var1.pos; // L: 121
		var1.pos += var9; // L: 122
		int var34 = var1.pos; // L: 123
		var1.pos += var16; // L: 124
		int var35 = var1.pos; // L: 125
		var1.pos += var18; // L: 126
		int var36 = var1.pos; // L: 127
		var1.pos += var20; // L: 128
		int var37 = var1.pos; // L: 129
		var1.pos += var7 + var8 + var11; // L: 130
		int var38 = var1.pos; // L: 131
		var1.pos += var7; // L: 132
		int var39 = var1.pos; // L: 133
		var1.pos += var27; // L: 134
		int var40 = var1.pos; // L: 135
		var1.pos += var8; // L: 136
		int var41 = var1.pos; // L: 137
		var1.pos += var17; // L: 138
		int var42 = var1.pos; // L: 139
		var1.pos += var19; // L: 140
		int var43 = var1.pos; // L: 141
		var1.pos += var21; // L: 142
		int var44 = var1.pos; // L: 143
		var1.pos += var12; // L: 144
		int var45 = var1.pos; // L: 145
		var1.pos += var9; // L: 146
		int var46 = var1.pos; // L: 147
		var1.pos += var22; // L: 148
		int var47 = var1.pos; // L: 149
		var1.pos += var23; // L: 150
		int var48 = var1.pos; // L: 151
		var1.pos += var24; // L: 152
		int var49 = var1.pos; // L: 153
		var1.pos += var25; // L: 154
		int var50 = var1.pos; // L: 155
		var1.pos += var5 * 3; // L: 156
		...
		var28 = 0; // L: 173
		label244 : for (int var60 = 0; var60 < var2; ++var60) { // L: 174
			var51.writeInt(1297379947); // L: 175
			var51.pos += 4; // L: 176
			int var61 = var51.pos; // L: 177
			int var62 = -1; // L: 178
			while (true) {
				while (true) {
					...
					if (var64 == 7) { // L: 185
						...
						var51.writeLengthInt(var51.pos - var61); // L: 269
						continue label244;
					}
					if (var64 == 23) { // L: 191
						if (var65) { // L: 192
					...
					while (var7 == var4.trackLengths[var6]) { // L: 291
						...
						if (var9 == 144) { // L: 313
							...
							if (var12 > 0) { // L: 317
								...
								ByteArrayNode var14 = (ByteArrayNode) this.table.get((long) var13); // L:
																									// 319
								if (var14 == null) { // L: 320
									var14 = new ByteArrayNode(new byte[128]); // L:
																				// 321
									this.table.put(var14, (long) var13); // L:
																			// 322
								}
