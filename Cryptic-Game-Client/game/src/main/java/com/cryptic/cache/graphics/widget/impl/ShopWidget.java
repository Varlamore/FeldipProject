...
public class ShopWidget extends Widget {
    ...
    private static void shop_with_close_button(AdvancedFont[] font) {
        ...
        addText(28064, "General", 0xffffff, false, true, 52, font, 2);
        addText(28065, "Cosmetic", 0xffffff, false, true, 52, font, 2);
        addText(28066, "Other", 0xffffff, false, true, 52, font, 2);
        setChildren(6, tab);
