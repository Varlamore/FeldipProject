...
public class MagicSidebarWidget extends Widget {
    ...
    private static void normals(AdvancedFont[] font) {
        ...
        for (int index = 57; index < 58; index++) {
            ...
            //Move varrock
            moveSpells.child_x[12] = 25;
            moveSpells.child_y[12] = 47;
    ...
    private static void arceuus() {
        Widget newInterfaceId = addTabInterface(839);
        setChildren(1, newInterfaceId);
        setBounds(40300, 0, 0, 0, newInterfaceId);
    }
    ...
    private static void ancients(AdvancedFont[] font) {
       ...
       // widget.child_x[15] = 154;
        ...
        VariableBits stfu = VariableBits.lookup(5963);
        int low2 = stfu.startBit;
        int high2 = stfu.endBit;
        int mask2 = Client.BIT_MASKS[high2 - low2];
        boolean inWild = (1 == (Client.instance.settings[stfu.baseVar] >> low2 & mask2));
        ...
        setBounds(34674, 152, 135, 1, newInterfaceId);
    ...
    private static void constructLunar() {
        ...
        int[] xCord = {
                10, 40, 71, 103, 135, 165,
                10, 40, 71, 103, 135, 165,
                10, 40, 71, 103, 135, 165,
                9, 40, 72, 103, 135, 165,
                10, 40, 72, 103, 135, 165,
                10, 40, 71, 103, 136, 165,
                9, 40, 71, 103,
        ...
        int[] yCord = {
                ...
                40, 40, 40, 40, 38, 39,
                70, 70, 69, 70, 70, 70,
                100, 100, 100, 97, 99, 99,
                130, 129, 130, 129, 129, 129,
                160, 160, 160, 160, 160, 159,
                190, 190, 190, 190, 184,

                176, 176, 176, 163, 176, 176,
                176, 163, 176, 176, 176, 176,
                163, 176, 163, 163, 163, 176,
                176, 176, 163, 176, 149, 176,
                163, 163, 176, 165, 176,
                9, 9, 9, 9, 9, 9, 9, 9, 9, 9 };
