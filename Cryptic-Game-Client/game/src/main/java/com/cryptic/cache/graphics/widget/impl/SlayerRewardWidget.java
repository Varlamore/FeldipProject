...
public class SlayerRewardWidget extends Widget {
    ...
    private static void unlock(AdvancedFont[] font) {
        ...
        for (int unlocks = 0; unlocks < amount_of_unlocks; unlocks++) {
            ...
            //63406 + 25 = 63431
            addContainerNoActions(63431 + unlocks, 1, 1, 1, 1, false, false);
            //We have to add a title on top of our interface, previously the child started at 63431, we add another 25 childs
            //63431 + 25 = 63456
            addText(63456 + unlocks, "Creature Name", font, 1, 0xff9040, false, true);
            ...
            scroll.child(unlocks + 25, 63431 + unlocks, 6 + scrollX, 3 + scrollY);
            //Here we add another 25 childs on top of the 25, so 25+25=50
            scroll.child(unlocks + 50, 63456 + unlocks, 60 + scrollX, 14 + scrollY);
    ...
    private static void extend(AdvancedFont[] font) {
        ...
        for (int extend_button = 0; extend_button < amount_of_extend_buttons; extend_button++) {
            ...
            //64306 + 25 = 64331
            addContainerNoActions(64331 + extend_button, 1, 1, 1, 1, false, false);
            //We have to add a title on top of our interface, previously the child started at 64331, we add another 25 childs
            //64331 + 25 = 64356
            addText(64356 + extend_button, "Creature Name", font, 1, 0xe59e44, false, true);
            ...
            scroll.child(extend_button + 25, 64331 + extend_button, 6 + scrollX, 3 + scrollY);

            //Here we add another 25 childs on top of the 25, so 25+25=50
            scroll.child(extend_button + 50, 64356 + extend_button, 60 + scrollX, 14 + scrollY);

            //We do exactly the same here, 50+25=75
            scroll.child(extend_button + 75, 64381 + extend_button, 7 + scrollX, 39 + scrollY);
    ...
    private static void task(AdvancedFont[] font) {
        ...
        tab.child(18, 63211, 328 + x, 125 + y);
        tab.child(19, 63212, 428 + x, 125 + y);
        ...
        for (int i = 0; i < 6; i++) {
            ...
            tab.child(39 + i, 63232 + i, 409 + x, 166 + y + yy);
            yy += 22;
        }
    }
