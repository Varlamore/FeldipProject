...
public final class AdvancedFont extends AbstractFont implements net.runelite.rs.api.RSFont {

    public AdvancedFont(byte[] fontData, int[] leftBearings, int[] topBearings, int[] widths, int[] heights, int[] var6, byte[][] pixels) {
        super(fontData, leftBearings, topBearings, widths, heights, var6, pixels);
    }

    public AdvancedFont(byte[] fontData) {
        super(fontData);
    }
