...
import static com.cryptic.util.ConfigUtility.*;
...
public class RaidsWidget extends Widget {
    ...
    private static void points(AdvancedFont[] font) {
        ...
        addOutlinedColorBox(12001, 0x534a40, 100, 40, 150);
        addText(12002, "", font, 1, 0xff981f, true, true);
        addText(12003, "Total: 84,306", font, 1, 0xff981f, false, true);
        addText(12004, "Origin: 12,724", font, 1, 0xff981f, false, true);
        addText(12005, "Time: 1:00", font, 1, 0xff981f, false, true);
        setBounds(12001, 15, 9, 0, points_widget);
        setBounds(12002, 30, 9, 1, points_widget);
        setBounds(12003, 17, 9, 2, points_widget);
        setBounds(12004, 17, 21, 3, points_widget);
        setBounds(12005, 17, 35, 4, points_widget);
    }
